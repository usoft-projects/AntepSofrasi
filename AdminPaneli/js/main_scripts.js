...
//DB-1 Config
var config = { 
    apiKey: "AIzaSyB4zQi6Ch96YFi84rytTxgtRLcSH_IH1go",
    authDomain: "antepsofrasi-1aca3.firebaseapp.com",
    databaseURL: "https://antepsofrasi-1aca3-default-rtdb.firebaseio.com",
    projectId: "antepsofrasi-1aca3",
    storageBucket: "antepsofrasi-1aca3.appspot.com",
    messagingSenderId: "864858661295",
    appId: "1:864858661295:web:ae8e277f50093088454f5a"
};
...
function newmenu(){
    ...
    Swal.fire({ 
        ...
        imageUrl: 'https://avatars.githubusercontent.com/u/110469572?v=4',
        imageWidth: 300,
        imageHeight: 300,
        imageAlt: 'Custom image',
        showCancelButton: true,
        ...
        if (result.isConfirmed) {
            ...
            if (file === undefined) {
                    ...
                    to_save.set(local_storage, function () {
                        ...
                        Swal.fire("Menü Eklendi. Antep Sofrası", '', 'info')
                    })
              }else{
                Swal.fire("Ekleniyor Bekleyiniz.", '', 'info')
                var to_save_image = firebase.storage().ref(path)
